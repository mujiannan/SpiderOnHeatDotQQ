...
datestr_end=input('结束日期(默认2020-03-26）：')
if datestr_end=='':
    datestr_end='2020-03-26'
...
for date_ in dates:
    ...
    recorder.save_json(obj_json=json_response,file_name='daily_visitor_rank'+'_'+adcode+'_'+datestr+'.json')
    print(datestr)
