...
datestr_end=input('结束日期(默认2020-02-29）：')
if datestr_end=='':
    datestr_end='2020-02-29'
...
for date_ in dates:
    ...
    json_response=heat_dot_qq.getMallRankingListCompetitive(adcode=adcode,date=datestr)
    recorder.save_json(obj_json=json_response,file_name='competitive_intensity'+'_'+adcode+'_'+datestr+'.json')
    print(datestr)
